        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-orange-200/65">
              Our platform offers intuitive and powerful tools to monitor and
              analyze the performance of chemical reactors at Syensqo Itatiba
              Plant. With real-time data visualization, customizable dashboards,
              and automated reporting, your team can quickly identify trends,
              detect inefficiencies, and drive continuous improvement in reactor
              operations.
            </p>
          </div>
          {/* Spotlight items */}
              ...
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-orange-200/65">
                    The Operator-Data interface allows operators to input and
                    access real-time reactor data, automatically generating
                    technical reports that highlight inefficiencies and support
