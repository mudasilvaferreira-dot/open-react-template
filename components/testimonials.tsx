        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              {/* Button #1 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${
                  category === 1
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 1 ? "text-orange-500" : "text-gray-600"
                  }`}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 2 ? "text-orange-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 3 ? "text-orange-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 4 ? "text-orange-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 5 ? "text-orange-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
