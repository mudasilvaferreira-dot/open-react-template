        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center md:pb-20">
            <h1
              ...
              data-aos="fade-up"
            >
              Syensqo Itatiba OEE Management
            </h1>
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                At Syensqo Itatiba Plant, OEE (Overall Equipment Effectiveness)
                is a key metric used to monitor and optimize the efficiency of
                chemical reactors by evaluating their availability, performance,
                and quality output.
              </p>
